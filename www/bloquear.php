...
require 'initialize.inc.php';
	if ($user->is_admin()==true ){
		...
		//listagem
		$query  = "SELECT R.Nome,R.CPF,R.email, B.MODO_bloqueio, B.Data FROM  bloqueio B,usuario U,responsavel R WHERE U.CPF=B.CPF AND R.CPF=U.CPF AND B.bloqueado=0";  /*Modificar o query para NAO mostrar só os que bloqueados */
